...
// A Lógica de Saque (efetuarSaque) - O Coração do Código
...
// Verificação de Cota Mínima
        if (getValorTotalDisponivel() < cotaMinima) {
            return "Caixa Vazio: Chame o Operador";
        }

/* O Cálculo das Notas: Ele cria um mapa temporário (notasParaEntregar). 
...
/* A conta logica: restante / nota. Se você quer R$ 130 e a nota é 100, o resultado é 1.
...
// Ele subtrai o valor do "restante" e passa para a próxima nota (50, 20, 10...).
